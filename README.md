# Product Analytics & Experimentation Project
...
- Event-based data modeling in PostgreSQL  
- SQL transformations and metric definitions  
- Retention analysis using cohort logic  
...
- **PostgreSQL** — event modeling and analytics queries  
- **SQL** — retention metric definition  
